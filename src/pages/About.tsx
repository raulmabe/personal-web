...
function About() {
  ...
  return (
    <div className="flex flex-row flex-grow justify-center">
      <div className="flex flex-col h-full space-y-14 md:space-y-24 mx-5 md:mx-10 max-w-screen-2xl">
        <h1 className="inline-block text-center  uppercase font-normal">
          About
          <TypedAboutMe
            strings={["Me", "Apps", "Games", "web", "dev", "code"]}
          />
        </h1>
        <div className="flex flex-row">
          ...
          <div className="flex flex-col md:px-10  md:w-2/3 items-center md:items-start">
            ...
            <p className="text-justify font-normal text-lg">
              ...
              <br />
              <br />I am a self-driven person who enjoys learning and creating
              all kinds of projects. Not only I relish working as a team as it
              requires communication and dedication, but also I have an open
              mind to new ideas and appreciate learning from others with more
              knowledge and experience. In addition, I am a positive person who
              enjoys maintaining the enthusiasm in a work environment. <br />
              <br />
              My expertise is composed of different types of projects, although
              I enjoy the most developing beautiful cross platform mobile apps
              based on the user experience, using{" "}
